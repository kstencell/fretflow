...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'background': '#ffffff', 'pie1': '#4285F4', 'pie2': '#EA4335', 'pie3': '#FBBC05', 'pie4': '#34A853', 'pie5': '#FF6D00', 'pie6': '#9B59B6', 'pieStrokeWidth': '2px', 'pieOpacity': '0.85'}}}%%
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'background': '#ffffff', 'pie1': '#FBBC05', 'pie2': '#4285F4', 'pieStrokeWidth': '2px', 'pieOpacity': '0.85'}}}%%
